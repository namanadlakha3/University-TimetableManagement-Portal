          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-blue-900 mb-4">Faculty Login</h1>
                <?php
              ...
              <form class="user" action="facultyLoginCode.php" method="POST">
                ...
                <div class="form-group">
				  ...
				  <a href="index.php" class="align-self-end"  style="float:right">Login as Student</a>
				</div>
